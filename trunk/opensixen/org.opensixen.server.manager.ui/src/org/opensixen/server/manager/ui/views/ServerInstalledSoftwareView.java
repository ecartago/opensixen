 ...
 */
public class ServerInstalledSoftwareView  extends ViewPart implements SelectionListener, ModifyListener {

	public static final String ID = "org.opensixen.server.manager.ui.serverInstalledSoftwareView";
	private Table table;
	...
	public void createPartControl(Composite parent) {
		...
		TableColumn col_id = new TableColumn (table, SWT.NONE);
		col_id.setText ("ID");
