...
/** Generated Model for V_Fact_Acct
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_V_Fact_Acct extends PO implements I_V_Fact_Acct, I_Persistent 
{
    ...
    /** Load Constructor */
    public X_V_Fact_Acct (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_V_Fact_Acct[")
	...
	{
		set_ValueNoCheck (COLUMNNAME_JournalNo, Integer.valueOf(JournalNo));
	}
	...
	{
		set_ValueNoCheck (COLUMNNAME_saldo, saldo);
	}
	...
	/** Set TR_TableName.
		@param TR_TableName TR_TableName	  */
	public void setTR_TableName (String TR_TableName)
	{
		set_ValueNoCheck (COLUMNNAME_TR_TableName, TR_TableName);
	}

	/** Get TR_TableName.
		@return TR_TableName	  */
	public String getTR_TableName () 
	{
		return (String)get_Value(COLUMNNAME_TR_TableName);
	}
